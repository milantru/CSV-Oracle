...
function TableKnowledgeDisplay({ tableKnowledge }: Props) {
	...
	function isCorrelatedWithSelectedColumn(columnKnowledgeIdx: number) {
		...
		/* The column, even though it is technically correlated with itself, correlation explanation for such pair won't be found, 
		 * because it was skipped on the server, therefore false will be returned, but for our usecase it is OK. */
